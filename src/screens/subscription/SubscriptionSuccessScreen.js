  ...
  return (
    <SafeAreaView style={styles(colors).container}>
        ...
        <View style={styles(colors).infoCard}>
          <View style={styles(colors).infoRow}>
            ...
            <Text style={styles(colors).infoText}>
              Your first meal delivery will arrive soon! You can track deliveries in the app.
            </Text>
          </View>
          ...
          <View style={styles(colors).infoRow}>
            ...
            <Text style={styles(colors).infoText}>
              You can manage or cancel your subscription anytime from your profile.
            </Text>
          </View>
      ...
      <View style={styles(colors).footer}>
        ...
        >
          <Text style={[styles(colors).buttonText, styles(colors).secondaryButtonText]}>View Subscription</Text>
        </TouchableOpacity>
