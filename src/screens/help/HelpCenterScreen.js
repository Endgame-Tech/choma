  ...
  const faqs = [
    {
      ...
      answer:
        "You can place an order by browsing our meal plans, selecting your preferred meals, and following the checkout process. We'll guide you through each step!",
    },
    {
      id: 2,
      question: "What are your delivery hours?",
      answer:
        "We deliver from 9 AM to 8 PM, Monday through Sunday. You can choose your preferred delivery time during checkout.",
    },
    {
      id: 3,
      question: "Can I modify my subscription?",
      answer:
        "Yes! You can modify, pause, or cancel your subscription anytime through your profile settings. Changes take effect from your next billing cycle.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      answer:
        "Once your order is confirmed, you'll receive a tracking link via SMS and email. You can also track your order in real-time through the app.",
    },
    {
      id: 6,
      question: "What if I'm not satisfied with my meal?",
      answer:
        "Your satisfaction is our priority! If you're not happy with any meal, please contact us within 24 hours and we'll make it right.",
    },
  ];
  ...
  const contactOptions = [
    {
      ...
      icon: "mail",
      action: () => Linking.openURL("mailto:support@Choma.app"),
    },
    {
      id: 2,
      title: "Call Us",
        ...
        <View style={styles(colors).section}>
          ...
          <TouchableOpacity style={styles(colors).resourceCard}>
            ...
            <View style={styles(colors).resourceContent}>
              ...
              <Text style={styles(colors).resourceSubtitle}>
          ...
          <TouchableOpacity
            style={styles(colors).resourceCard}
