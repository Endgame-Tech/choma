        ...
        >
          ...
          >
            ...
            <View style={styles.welcomeContainer}>
              ...
              <Text style={styles.welcomeSubtitle}>First lets verify your email address to</Text>
              ...
              >
                {isLoading ? (
                  ...
                  <View style={styles.buttonRow}>
                    ...
                    <Text style={styles.verifyButtonText}>Continue to Signup</Text>
                  </View>
                ) : (
              ...
              <View style={styles.infoContainer}>
                {isAlreadyVerified ? (
                  <>
                    ...
                    <Text style={styles.infoText}>Ready to create your account</Text>
                  </>
                ) : (
                  <>
                    <Text style={styles.infoText}>We'll send a 6-digit verification code</Text>
                    <Text style={styles.infoText}>Your email will be kept secure and private</Text>
                    <Text style={styles.infoText}>Code expires in 5 minutes for security</Text>
                  </>
                )}
              </View>
            </View>
