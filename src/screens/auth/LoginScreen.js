        ...
        <ScrollView contentContainerStyle={styles(colors).scrollContainer}>
          ...
          <View style={styles(colors).content}>
            <View style={styles(colors).logoContainer}>
              ...
              <Text style={styles(colors).subtitle}>Sign in to your MyChef account</Text>
            </View>
            ...
            <View style={styles(colors).form}>
              ...
              <TouchableOpacity 
                style={[styles(colors).loginButton, isLoading && styles(colors).loginButtonDisabled]}
                onPress={handleLogin}
                disabled={isLoading}
              >
                <LinearGradient
              ...
              <View style={styles(colors).optionsRow}>
                <TouchableOpacity style={styles(colors).forgotPassword}>
