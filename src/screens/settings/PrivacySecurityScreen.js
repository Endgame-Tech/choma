        ...
        async () => {
          try {
            ...
            if (result?.success) {
              ...
              showError(
                "Export Failed",
                "Unable to process data export request. Please try again."
              );
            }
          } catch (error) {
    ...
    showConfirm(
      ...
      () => {
        ...
        showConfirm(
          ...
          async () => {
            console.log(
              "🗑️ Final confirmation accepted, proceeding with deletion"
            );
            try {
              setSaveLoading(true);
        ...
        >
          ...
          <View style={styles.infoSection}>
            ...
            <Text style={styles.infoText}>
              ...
              personal data. Read our full privacy policy to understand how we
