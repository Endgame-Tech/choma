...
const SettingsScreen = ({ navigation }) => {
  ...
  const handleAbout = () => {
    Alert.alert(
      'About MyChef',
      'Version 1.0.0\nBuilt with ❤️ for food lovers\n\n© 2024 MyChef. All rights reserved.',
  ...
  const handleTerms = () => {
    Alert.alert(
      'Terms of Service',
      'By using MyChef, you agree to our terms and conditions.',
      [
  ...
  const renderSettingItem = (icon, title, subtitle, value, onToggle, isSwitch = true) => (
    <View style={styles(colors).settingItem}>
      ...
      <View style={styles(colors).settingContent}>
        ...
        {subtitle && <Text style={styles(colors).settingSubtitle}>{subtitle}</Text>}
      </View>
      {isSwitch ? (
        <Switch
          value={value}
  ...
  const renderActionItem = (icon, title, subtitle, onPress, color = colors.text) => (
      ...
      <ScrollView style={styles(colors).scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles(colors).section}>
          ...
          {renderActionItem(
            ...
            () => Alert.alert('Contact Us', 'Email: support@mychef.app\nPhone: +234 123 456 7890')
          )}
          ...
          {renderActionItem(
            ...
            () => Alert.alert('Rate MyChef', 'Thank you for using MyChef! Please rate us on the app store.')
          )}
        </View>
        ...
        <View style={styles(colors).section}>
          ...
          {renderActionItem(
            ...
            () => Alert.alert('Updates', 'You have the latest version of MyChef!')
          )}
        </View>

        {/* Danger Zone */}
        <View style={styles(colors).section}>
          <Text style={[styles(colors).sectionTitle, styles(colors).dangerTitle]}>Account</Text>
