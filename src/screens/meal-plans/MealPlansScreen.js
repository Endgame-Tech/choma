        ...
        <View style={styles(colors).cardContainer}>
          ...
          <View style={styles(colors).planInfo}>
            ...
            <View style={styles(colors).featuresContainer}>
              {(plan.features || []).slice(0, 2).map((feature, index) => (
                <View key={index} style={styles(colors).featureItem}>
                  <Ionicons name="checkmark-circle" size={14} color={plan.gradient[0]} />
            ...
            <View style={styles(colors).pricingContainer}>
              ...
              <TouchableOpacity 
                style={[styles(colors).selectButton, { backgroundColor: plan.gradient[0] }]}
      ...
      >
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {activeFilters.audiences && activeFilters.audiences.length > 0 && (
                <View style={styles(colors).activeFilterChip}>
                  ...
                  <TouchableOpacity onPress={() => clearSpecificFilter('audiences')}>
              ...
              {activeFilters.priceRange && (activeFilters.priceRange[0] > 0 || activeFilters.priceRange[1] < 50000) && (
                <View style={styles(colors).activeFilterChip}>
                  ...
                  <TouchableOpacity onPress={() => clearSpecificFilter('priceRange')}>
                    <Ionicons name="close" size={16} color={colors.primary} />
                  </TouchableOpacity>
                </View>
              )}
              {activeFilters.duration && (
                <View style={styles(colors).activeFilterChip}>
                  ...
                  <TouchableOpacity onPress={() => clearSpecificFilter('duration')}>
                    <Ionicons name="close" size={16} color={colors.primary} />
                  </TouchableOpacity>
                </View>
              )}
            ...
            {filteredMealPlans.length > 0 ? (
              ...
              <View style={styles(colors).emptyContainer}>
                ...
                <Text style={styles(colors).emptyTitle}>
                  {hasActiveFilters ? 'No plans match your filters' : 'No meal plans available'}
                </Text>
                <Text style={styles(colors).emptyText}>
                  {hasActiveFilters ? 'Try adjusting your filters to see more plans' : 'Check back later for new meal plans!'}
                </Text>
                {hasActiveFilters && (
                  <TouchableOpacity 
        ...
        <View style={styles(colors).compareSection}>
          <TouchableOpacity style={styles(colors).compareButton}>
            ...
            <Text style={styles(colors).compareButtonText}>Compare All Plans</Text>
        ...
        <View style={styles(colors).faqSection}>
          <Text style={styles(colors).faqTitle}>Frequently Asked Questions</Text>
          
          <TouchableOpacity style={styles(colors).faqItem}>
            <Text style={styles(colors).faqQuestion}>Can I pause my subscription?</Text>
            <Ionicons name="chevron-down" size={16} color={colors.textSecondary} />
          </TouchableOpacity>
          
          <TouchableOpacity style={styles(colors).faqItem}>
            <Text style={styles(colors).faqQuestion}>How do I customize my meals?</Text>
            <Ionicons name="chevron-down" size={16} color={colors.textSecondary} />
          </TouchableOpacity>
          
          <TouchableOpacity style={styles(colors).faqItem}>
            <Text style={styles(colors).faqQuestion}>What if I don't like a meal?</Text>
            <Ionicons name="chevron-down" size={16} color={colors.textSecondary} />
          </TouchableOpacity>
        </View>
