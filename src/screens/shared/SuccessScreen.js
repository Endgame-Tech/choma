      ...
      return (
        <View style={styles(colors).illustrationContainer}>
          ...
          <View style={styles(colors).deliveryPersonContainer}>
            ...
            <View style={[styles(colors).deliveryIcon, styles(colors).deliveryIcon1]}>
              <Ionicons name="fast-food" size={24} color={colors.error} />
            </View>
            <View style={[styles(colors).deliveryIcon, styles(colors).deliveryIcon2]}>
              <Ionicons name="receipt" size={20} color={colors.primary} />
            </View>
            <View style={[styles(colors).deliveryIcon, styles(colors).deliveryIcon3]}>
  ...
  <SuccessScreen 
    route={{
      params: {
        ...
        subtitle: 'Your subscription is now active. Get ready for delicious, healthy meals!',
