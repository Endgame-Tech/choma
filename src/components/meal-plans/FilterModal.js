...
const FilterModal = ({ 
  ...
  const [selectedSort, setSelectedSort] = useState(initialFilters.sortBy || 'popularity');
  const [selectedDuration, setSelectedDuration] = useState(initialFilters.duration || null);
    ...
    >
      ...
      <SafeAreaView style={styles(colors).container}>
        ...
        <View style={styles(colors).header}>
          ...
          <TouchableOpacity onPress={clearAllFilters} style={styles(colors).clearButton}>
              ...
              {DURATION_OPTIONS.map((duration) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    selectedDuration === duration.id && styles(colors).durationItemSelected
                  ]}
                ...
                >
                  <Text 
                    style={[
                      ...
                      selectedDuration === duration.id && styles(colors).durationNameSelected
                    ]}
                  >
                    {duration.name}
                  </Text>
                  <Text 
                    style={[
                      ...
                      selectedDuration === duration.id && styles(colors).durationDaysSelected
                    ]}
                  >
                    {duration.days} days
                  </Text>
                ...
                <View style={styles(colors).sortContent}>
                  ...
                  <Text 
                    style={[
                      ...
                      selectedSort === option.id && styles(colors).sortNameSelected
                    ]}
                  >
                    {option.name}
                  </Text>
