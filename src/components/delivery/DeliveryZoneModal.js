  ...
  const renderEmptyState = () => (
    <View style={styles(colors).emptyState}>
      ...
      <Text style={styles(colors).emptyMessage}>
        We don't have delivery zones set up yet. Please contact support for assistance.
      </Text>
    </View>
  );
      ...
      <View style={styles(colors).modalOverlay}>
        <View style={styles(colors).modalContent}>
          ...
          <View style={styles(colors).modalHeader}>
            <View>
              <Text style={styles(colors).modalTitle}>Select Delivery Zone</Text>
          ...
          <View style={styles(colors).listContainer}>
            {loading ? (
              <View style={styles(colors).loadingContainer}>
                ...
                <Text style={styles(colors).loadingText}>Loading delivery zones...</Text>
              </View>
              ...
              <View style={styles(colors).noResultsContainer}>
                ...
                <Text style={styles(colors).noResultsTitle}>No zones found</Text>
