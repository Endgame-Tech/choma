      ...
      <View style={styles(colors).overlay}>
        <View style={styles(colors).container}>
          <View style={styles(colors).content}>
            ...
            {/* Message */}
            {message && (
              <Text style={styles(colors).message}>{message}</Text>
            )}

            {/* Buttons */}
            <View style={[
              styles(colors).buttonContainer,
              defaultButtons.length > 2 && styles(colors).verticalButtonContainer
            ]}>
              {defaultButtons.map((button, index) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    button.style === 'destructive' && styles(colors).destructiveButton,
                ...
                >
                  {button.style === 'default' || button.style === 'destructive' ? (
                    <LinearGradient
                      colors={
                    ...
                    >
                      <Text style={[
                        ...
                        button.style === 'destructive' && styles(colors).destructiveButtonText
                      ]}>
                        {button.text}
                      </Text>
                    </LinearGradient>
