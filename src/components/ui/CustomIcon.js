...
import CowbellIcon from '../../../assets/images/icons/ui/cowbell.svg';
import CowbellFilledIcon from '../../../assets/images/icons/ui/cowbell-filled.svg';
...
import WalletIcon from '../../../assets/images/icons/ui/wallet-filled.svg';
...
const iconMap = {
  ...
  'cowbell': CowbellIcon,
  'cowbell-filled': CowbellFilledIcon,
  ...
  'wallet': WalletIcon,
  'wallet-filled': WalletIcon,
  
  // Common icon name mappings for compatibility
  'gift-outline': MedalIcon,
  'chevron-forward': ReorderIcon,
  'ellipsis-horizontal': SettingsIcon,
  'pause': ClockIcon,
  'restaurant-outline': FoodIcon,
  'alert-circle': ShieldIcon,
  'close': ReorderIcon, // You might want to create a specific close icon
  'information-circle': DetailsIcon,
  'nutrition': FoodIcon,
  'close-circle': ReorderIcon,
...
const CustomIcon = ({ 
  ...
  if (!IconComponent) {
    console.warn(`CustomIcon: Icon "${name}" not found. Available icons:`, Object.keys(iconMap));
