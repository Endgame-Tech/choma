        ...
        <View style={styles.levelHeader}>
          ...
          <View style={styles.levelInfo}>
            ...
            <Text style={styles.pointsText}>
              {loyaltyStats.currentPoints} Points
            </Text>
          </View>
        </View>
        ...
        {loyaltyStats.nextLevel && (
          <View style={styles.progressContainer}>
            ...
            <Text style={styles.progressText}>
              {loyaltyStats.pointsToNextLevel} points to{" "}
              {loyaltyStats.nextLevel}
            </Text>
          </View>
        )}
      ...
      <View style={styles.section}>
        ...
        {allRewards.map((reward) => {
          ...
          return (
            <View
              key={reward.id}
              style={[styles.rewardCard, !canRedeem && styles.lockedReward]}
            >
              <View style={styles.rewardIcon}>
                <Ionicons
                  name={reward.icon}
              ...
              <View style={styles.rewardInfo}>
                <Text
                  style={[styles.rewardName, !canRedeem && styles.lockedText]}
                >
                  {reward.name}
                </Text>
                <Text
                  style={[
                    ...
                    !canRedeem && styles.lockedText,
                  ]}
                >
                  {reward.description}
                </Text>
                <Text
                  style={[styles.rewardPoints, !canRedeem && styles.lockedText]}
                >
                  {reward.pointsCost} points
                </Text>
              </View>
