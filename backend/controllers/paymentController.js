      ...
      try {
        ...
        if (response.data.status && response.data.data.status === 'success') {
          ...
          try {
            ...
            console.error('Payment success notification failed:', notificationError);
          }
          ...
          try {
            ...
            if (customerId) {
              await NotificationService.notifyPaymentFailed(customerId, {
                reference,
                reason: response.data.data?.gateway_response || 'Payment not successful'
              });
            }
          } catch (notificationError) {
      ...
      if (subscriptionId) {
        ...
        if (subscription) {
          ...
          const order = await Order.create({
            ...
            orderItems: {
              mealPlan: subscription.mealPlanId._id,
          ...
          try {
            ...
            console.error('Subscription created notification failed:', notificationError);
          }
        }
      }
