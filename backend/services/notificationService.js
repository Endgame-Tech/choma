...
class NotificationService {
  ...
  static async createNotification(notificationData) {
    try {
      ...
      const user = await Customer.findById(userId).select('notificationPreferences pushToken');
  ...
  static async notifyWelcome(userId, userName) {
    return await this.createNotification({
      ...
      message: 'Get started by exploring our delicious meal plans tailored just for you.',
      type: 'welcome',
      data: { userName },
      priority: 'medium'
    });
  ...
  static async notifyProfileIncomplete(userId) {
    return await this.createNotification({
      ...
      message: 'Complete your profile to get personalized meal recommendations and better service.',
  ...
  static async notifySubscriptionCancelled(userId, subscriptionData) {
    return await this.createNotification({
      ...
      message: 'Your subscription has been cancelled successfully. We hope to serve you again soon!',
  ...
  static async notifyOrderDelivered(userId, orderData) {
    return await this.createNotification({
      ...
      message: 'Your meal has been delivered. Enjoy your delicious food! Please rate your experience.',
  ...
  static async notifyOrderCancelled(userId, orderData) {
    return await this.createNotification({
      ...
      message: `Order #${orderData.orderNumber} has been cancelled. ${orderData.reason ? `Reason: ${orderData.reason}` : ''}`,
  ...
  static async notifyChefAssigned(userId, chefData) {
    return await this.createNotification({
      userId,
      title: 'Chef Assigned! 👨‍🍳',
      message: `${chefData.name} will be preparing your meal. They specialize in ${chefData.specialties.join(', ')}.`,
      type: 'chef_assigned',
      data: chefData,
      priority: 'medium'
    });
  ...
  static async notifyNewMealPlans(userId, mealPlanData) {
    return await this.createNotification({
      ...
      message: `Check out our latest meal plans: ${mealPlanData.planNames.join(', ')}. Limited time offer!`,
      type: 'new_meal_plans',
      data: mealPlanData,
      priority: 'low'
    });
