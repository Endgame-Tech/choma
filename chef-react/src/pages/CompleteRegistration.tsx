    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-left mb-6">
              ...
              <p className="text-gray-600">Tell us about your culinary expertise</p>
            </div>
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div className="text-left mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Location & Service Area</h2>
              <p className="text-gray-600">Let us know where you're located and how far you can serve</p>
            </div>
          ...
          <div className="bg-white">
            ...
            <div className="flex justify-between mt-8">
              ...
              {currentStep < steps.length ? (
                <button
                  onClick={handleNext}
                  className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-[1.02]"
                >
                  Next
                </button>
              ) : (
                <button
                  ...
                  disabled={isLoading}
                  className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
                  {isLoading ? (
                    <div className="flex items-center">
