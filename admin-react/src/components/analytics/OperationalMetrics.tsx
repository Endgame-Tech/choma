        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <MetricProgressBar
                value={data.chefUtilization}
                colorThresholds={{ good: 80, fair: 60 }}
              />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className={`text-sm font-semibold ${data.cancellationRate <= 5 ? 'text-green-600' :
              ...
              <MetricProgressBar
                ...
                maxValue={20}
                colorThresholds={{ good: 5, fair: 10 }}
                isInverse={true}
              />
            </div>
          </div>
            ...
            {data.peakHours.slice(0, 6).map((hour, index) => (
              <div key={index} className="flex items-center">
                ...
                <div className="flex-1 mx-3">
                  <MetricProgressBar 
                    value={hour.orders}
                    maxValue={maxPeakOrders}
                    colorThresholds={{ good: 0, fair: 0 }}
                  />
                </div>
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="text-right">
        {(() => {
          ...
          return (
            <div className={`text-3xl font-bold ${score >= 85 ? 'text-green-600' :
