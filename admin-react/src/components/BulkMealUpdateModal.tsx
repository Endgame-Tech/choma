  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      for (const row of jsonData) {
        ...
        // Pricing updates
                const pricingUpdates: Partial<Meal["pricing"]> = {}
                ...
                for (const field of pricingFields) {
                  ...
                  const originalVal = originalMeal.pricing?.[field] ?? 0
        ...
        // Nutrition updates
        const nutritionUpdates: Partial<Meal['nutrition']> = {}
        ...
        for (const field of nutritionFields) {
          ...
          const originalVal = originalMeal.nutrition?.[field] ?? 0
          if (newValue !== originalVal) {
